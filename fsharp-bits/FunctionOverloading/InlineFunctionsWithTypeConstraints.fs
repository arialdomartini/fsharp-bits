module FSharpBits.MonadTransformers.FunctionOverloading.InlineFunctionsWithTypeConstraints
...
let inline genericJoin (a: ^a) (b: ^a) : 'a when (^a) : (static member Join : ^a * ^a -> ^a) =
